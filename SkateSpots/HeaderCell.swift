...
class HeaderCell: UITableViewCell, UITextViewDelegate{
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        profilePhoto = UIImageView()
              profilePhoto.frame = CGRect(x: screenSize.width / 2 - 45, y: 10, width: 90, height: 90)
              ...
              userName = UILabel()
              userName.frame = CGRect(x: 0 , y: profilePhoto.frame.maxY + 10, width: screenSize.width, height: 20)
              userName.textAlignment = .center
              userName.textColor = UIColor.black
              userName.font = UIFont(name: "Avenir-Bold",size: 16)
              ...
              igLink.titleLabel?.font = UIFont(name: "Avenir",size: 14)
              ...
              contributions.frame = CGRect(x: self.frame.width / 2 - 40 , y: igLink.frame.origin.y + 85, width: 150, height: 20)
